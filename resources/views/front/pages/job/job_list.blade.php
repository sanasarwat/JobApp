                    ...
                    <div class="col-lg-12">
                        <div class="show-results">
                            <div class="float-left">
                                <h5 class="text-dark mb-0 pt-2 f-18">Showing results 1-20</h5>
                            </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-2">
                                        <div class="company-logo-img">
                                            <img src="{{ asset('images/front_img/featured-job/img-1.png') }}" alt=""
                                    ...
                                    <div class="col-lg-7 col-md-9">
                                        <div class="job-list-desc">
                                            <h6 class="mb-2">
                                                <a href="{{url('/job-detail/'.$jobList->id)}}" class="text-dark">{{ $jobList->job_title }}</a>
                                        </h6>
                                            <p class="text-muted mb-0"><i class="mdi mdi-bank mr-2"></i> {{ $jobList->company_name }}</p>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item mr-3">
                                                    <p class="text-muted mb-0"><i class="mdi mdi-map-marker mr-2"></i> {{ $jobList->address }}</p>
                                                </li>
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                        <div class="job-list-button-sm text-right">
                                            <span class="badge badge-success"> {{ $jobList->job_type }}</span>
